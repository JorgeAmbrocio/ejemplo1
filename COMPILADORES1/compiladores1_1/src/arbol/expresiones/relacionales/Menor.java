...
public class Menor extends Expresion {
    ...
    public Expresion getValor(Entorno ent) {
        ...
        Errores errr = new Errores(Errores.enumTipoError.semantico , "No se pueden ejecutar MENOR QUE con los tipos " + e1.tipo.tipo.toString() + "-" + e2.tipo.tipo.toString() + " Linea " + this.linea + "Columan " +  this.columna);
