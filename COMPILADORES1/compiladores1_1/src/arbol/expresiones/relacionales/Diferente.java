...
public class Diferente extends Expresion {
    ...
    public Diferente(Expresion izquierda, Expresion derecha, int linea, int columna) {
    ...
    public Expresion getValor(Entorno ent) {
        ...
        Errores errr = new Errores(Errores.enumTipoError.semantico , "No se pueden ejecutar DIFERENTE QUE con los tipos " + e1.tipo.tipo.toString() + "-" + e2.tipo.tipo.toString() + " Linea " + this.linea + "Columan " +  this.columna);
